...
\begin{minipage}[t]{0.28\textwidth} % 27.5% of the page width for the first row of icons
	...
	\icon{MapMarker}{16}{7388 Stone Valley Lane}\\
	\icon{EllipsisV}{16}{New Albany, OH 43054}\\
...
\begin{minipage}[t]{0.3\textwidth}
	...
	\cvsect{GraduationCap}{Languages}
...
\begin{minipage}[t]{0.3\textwidth}
	...
	\cvsect{GraduationCap}{Non profit}
